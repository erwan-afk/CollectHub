...
export const ExtractedInvoiceSchema = z.object({
  ...
  confidence: z.record(z.number().min(0).max(1)).describe('Score de confiance par champ (0-1)'),
});
...
export const EXTRACT_INVOICE_TOOL: Anthropic.Tool = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      siret: { type: ['string', 'null'], description: 'SIRET émetteur (14 chiffres, sans espaces)' },
